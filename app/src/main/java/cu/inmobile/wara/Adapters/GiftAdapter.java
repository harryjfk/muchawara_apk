...
import cu.inmobile.wara.Activities.RefillCreditsActivity;
import cu.inmobile.wara.Applications.WaraApp;
import cu.inmobile.wara.Models.Gifts;
...
public class GiftAdapter extends RecyclerView.Adapter<GiftAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(GiftAdapter.MyViewHolder holder, int position) {
        cu.inmobile.wara.Models.Gifts gift = Gifts.get(position);
        ...
        public MyViewHolder(View view) {
            ...
            gift_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    cu.inmobile.wara.Models.Gifts gift = Gifts.get(getAdapterPosition());
                    if(gift.getPrice() < WaraApp.balas){
