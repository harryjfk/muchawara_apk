...
import cu.inmobile.wara.Adapters.HighlightAdapter;
import cu.inmobile.wara.Adapters.PaymentAdapter;
...
import cu.inmobile.wara.Utils.PaymentResolver;
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        ...
                        try {
                            ...
                            if (jsonObject.optBoolean(Const.Params.SUCCESS)) {
                                ...
                                WaraApp.balas = Integer.parseInt(credit, 0);
