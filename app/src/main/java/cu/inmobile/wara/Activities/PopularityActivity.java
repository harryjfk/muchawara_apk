...
public class PopularityActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Glide.with(this).load(WaraApp.imageUrl).placeholder(R.drawable.profile_placeholder).dontAnimate().into(p1);
        Glide.with(this).load(WaraApp.imageUrl).placeholder(R.drawable.profile_placeholder).dontAnimate().into(p2);
